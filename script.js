...
// Inputs for usernames
const myUsernameInput = document.getElementById('my-username'); // Input for your name
const otherUsernameInput = document.getElementById('other-username'); // Input for other user's name
